...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mwcnrtomcn(size_t* __p_maybe_dst_len,
     char** __p_maybe_dst, size_t* __p_src_len, const wchar_t** __p_src, cnc_mcstate_t* __p_state)
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mwcntomcn(
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mwcnrtomwcn(size_t* __p_maybe_dst_len,
     wchar_t** __p_maybe_dst, size_t* __p_src_len, const wchar_t** __p_src,
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mwcnrtoc8n(size_t* __p_maybe_dst_len,
     ztd_char8_t** __p_maybe_dst, size_t* __p_src_len, const wchar_t** __p_src,
     cnc_mcstate_t* __p_state) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	cnc_mcstate_t __substitute_state {};
	if (__p_state == nullptr)
		__p_state = &__substitute_state;
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mwcnrtoc16n(size_t* __p_maybe_dst_len,
     ztd_char16_t** __p_maybe_dst, size_t* __p_src_len, const wchar_t** __p_src,
     cnc_mcstate_t* __p_state) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	cnc_mcstate_t __substitute_state {};
	if (__p_state == nullptr)
		__p_state = &__substitute_state;
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mwcnrtoc32n(size_t* __p_maybe_dst_len,
     ztd_char32_t** __p_maybe_dst, size_t* __p_src_len, const wchar_t** __p_src,
     cnc_mcstate_t* __p_state) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	cnc_mcstate_t __substitute_state {};
	if (__p_state == nullptr)
		__p_state = &__substitute_state;
