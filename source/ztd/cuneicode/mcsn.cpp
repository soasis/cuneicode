...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mcsnrtomcsn(size_t* __p_maybe_dst_len,
     char** __p_maybe_dst, size_t* __p_src_len, const char** __p_src, cnc_mcstate_t* __p_state)
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mcsntomcsn(size_t* __p_maybe_dst_len,
     char** __p_maybe_dst, size_t* __p_src_len, const char** __p_src) ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mcsnrtomwcsn(size_t* __p_maybe_dst_len,
     wchar_t** __p_maybe_dst, size_t* __p_src_len, const char** __p_src, cnc_mcstate_t* __p_state)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX) {
	if (__p_maybe_dst == nullptr || *__p_maybe_dst == nullptr) {
		if (__p_maybe_dst_len == nullptr) {
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mcsntomwcsn(
...
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_mcsnrtoc8sn(size_t* __p_maybe_dst_len,
     ztd_char8_t** __p_maybe_dst, size_t* __p_src_len, const char** __p_src,
