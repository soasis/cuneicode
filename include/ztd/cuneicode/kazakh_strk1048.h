...
cnc_mcerr cnc_c32ntomcn_kazakh_strk1048(size_t* __p_maybe_dst_len, ztd_char_t** __p_maybe_dst,
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_USE(ZTD_CUNEICODE_API_LINKAGE)
cnc_mcerr cnc_c32nrtomcn_kazakh_strk1048(size_t* __p_maybe_dst_len, ztd_char_t** __p_maybe_dst,
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_USE(ZTD_CUNEICODE_API_LINKAGE)
cnc_mcerr cnc_c32sntomcsn_kazakh_strk1048(size_t* __p_maybe_dst_len, ztd_char_t** __p_maybe_dst,
     size_t* __p_src_len, const ztd_char32_t** __p_src) ZTD_USE(ZTD_NOEXCEPT_IF_CXX);
