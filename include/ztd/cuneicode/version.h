...
#else
#define ZTD_CUNEICODE_API_LINKAGE_I_ ZTD_API_LINKAGE_I_
#endif

#if defined(ZTD_CUNEICODE_C_LANGUAGE_LINKAGE)
#define ZTD_CUNEICODE_C_LANGUAGE_LINKAGE_I_ ZTD_CUNEICODE_C_LANGUAGE_LINKAGE
#else
#define ZTD_CUNEICODE_C_LANGUAGE_LINKAGE_I_ ZTD_C_LANGUAGE_LINKAGE_I_
#endif

#if defined(ZTD_CUNEICODE_CXX_LANGUAGE_LINKAGE)
#define ZTD_CUNEICODE_CXX_LANGUAGE_LINKAGE_I_ ZTD_CUNEICODE_CXX_LANGUAGE_LINKAGE
#else
#define ZTD_CUNEICODE_CXX_LANGUAGE_LINKAGE_I_ ZTD_CXX_LANGUAGE_LINKAGE_I_
#endif
