...
cnc_mcerr cnc_c32ntomcn_petscii_unshifted(size_t* __p_maybe_dst_len, ztd_char_t** __p_maybe_dst,
...
cnc_mcerr cnc_mcnrtoc32n_petscii_unshifted(size_t* __p_maybe_dst_len, ztd_char32_t** __p_maybe_dst,
     size_t* __p_src_len, const ztd_char_t** __p_src, cnc_petscii_state_t* __p_state)
     ZTD_USE(ZTD_NOEXCEPT_IF_CXX);
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_USE(ZTD_CUNEICODE_API_LINKAGE)
cnc_mcerr cnc_c32sntomcsn_petscii_unshifted(size_t* __p_maybe_dst_len, ztd_char_t** __p_maybe_dst,
     size_t* __p_src_len, const ztd_char32_t** __p_src) ZTD_USE(ZTD_NOEXCEPT_IF_CXX);
