...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_replace_error_mwcntomcn_wide_exec_utf8(
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_replace_error_mcntomwcn_utf8_wide_exec(
     cnc_mcerr __current_error, size_t* restrict __p_maybe_dst_len,
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_replace_error_mcntoc8n_utf8(cnc_mcerr __current_error,
     size_t* restrict __p_maybe_dst_len, ztd_char8_t* restrict* restrict __p_maybe_dst,
     size_t* restrict __p_src_len, const ztd_char_t* restrict* restrict __p_src,
     void* restrict __p_state, void* restrict __p_user_data) ZTD_USE(ZTD_NOEXCEPT_IF_CXX);
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_replace_error_mcntoc16n_utf8(cnc_mcerr __current_error,
     size_t* restrict __p_maybe_dst_len, ztd_char16_t* restrict* restrict __p_maybe_dst,
     size_t* restrict __p_src_len, const ztd_char_t* restrict* restrict __p_src,
     void* restrict __p_state, void* restrict __p_user_data) ZTD_USE(ZTD_NOEXCEPT_IF_CXX);
...
ZTD_USE(ZTD_C_LANGUAGE_LINKAGE)
ZTD_CUNEICODE_API_LINKAGE_I_ cnc_mcerr cnc_replace_error_mcntoc32n_utf8(cnc_mcerr __current_error,
     size_t* restrict __p_maybe_dst_len, ztd_char32_t* restrict* restrict __p_maybe_dst,
     size_t* restrict __p_src_len, const ztd_char_t* restrict* restrict __p_src,
     void* restrict __p_state, void* restrict __p_user_data) ZTD_USE(ZTD_NOEXCEPT_IF_CXX);
