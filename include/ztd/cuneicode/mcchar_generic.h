...
#define cnc_cxntocyn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src)        \
	__cnc_detail_cxntocxn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src)( \
	     __p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src)
...
#define cnc_cxnrtocyn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state)        \
	__cnc_detail_cxnrtocxn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state)( \
	     __p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state)
...
#define cnc_cxsntocysn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src)        \
	__cnc_detail_cxsntocxsn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src)( \
	     __p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src)
...
#define cnc_cxsnrtocysn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state)        \
	__cnc_detail_cxsnrtocxsn(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state)( \
	     __p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state)
...
/// storage duration (it is a "stack"-based variable that does not live beyond the call of this
/// function).
#define cnc_cxntocyn_with_handler(                                                                \
     __p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __error_handler, __p_user_data)      \
	__cnc_detail_cxntocxn_with_handler(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src,   \
	     __error_handler, __p_user_data)(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, \
	     __cnc_detail_select_error_handler_cxntocyn(__error_handler, __p_maybe_dst, __p_src),    \
	     __p_user_data)
...
/// &state);
/// ```
#define cnc_cxnrtocyn_with_handler(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src,       \
     __p_state, __error_handler, __p_user_data)                                                  \
	__cnc_detail_cxnrtocxn_with_handler(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, \
	     __p_state, __error_handler,                                                            \
	     __p_user_data)(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state,      \
	     __cnc_detail_select_error_handler_cxntocyn(__error_handler, __p_maybe_dst, __p_src),   \
	     __p_user_data)
...
/// storage duration (it is a "stack"-based variable that does not live beyond the call of this
/// function).
#define cnc_cxsntocysn_with_handler(                                                              \
     __p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __error_handler, __p_user_data)      \
	__cnc_detail_cxsntocxsn_with_handler(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, \
	     __error_handler, __p_user_data)(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, \
	     __cnc_detail_select_error_handler_cxntocyn(__error_handler, __p_maybe_dst, __p_src),    \
	     __p_user_data)
...
/// &state);
/// ```
#define cnc_cxsnrtocysn_with_handler(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src,       \
     __p_state, __error_handler, __p_user_data)                                                    \
	__cnc_detail_cxsnrtocxsn_with_handler(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, \
	     __p_state, __error_handler,                                                              \
	     __p_user_data)(__p_maybe_dst_len, __p_maybe_dst, __p_src_len, __p_src, __p_state,        \
	     __cnc_detail_select_error_handler_cxntocyn(__error_handler, __p_maybe_dst, __p_src),     \
	     __p_user_data)
