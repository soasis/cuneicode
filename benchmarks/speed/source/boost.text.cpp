...
#define UTF_CONVERSION_BENCHMARK(FROM_N, TO_N)                                                  \
	static void utf##FROM_N##_to_utf##TO_N##_well_formed_boost_text(benchmark::State& state) { \
		...
		for (auto _ : state) {                                                                \
			...
			auto position                                                                    \
			     = boost::text::transcode_to_utf##TO_N(input, input + input_size, output);   \
			if (position.in != (input + input_size)                                          \
			     || position.out != (output + output_size)) {                                \
				result = false;                                                             \
			}                                                                                \
		}                                                                                     \
		...
		if (!result || !is_equal) {                                                           \
			...
			return;                                                                          \
                                                                                                ...
                                                                                                \
	static void utf##FROM_N##_to_utf##TO_N##_well_formed_boost_text_view(                      \
