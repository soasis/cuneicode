#ifndef ZTD_CUNEICODE_SPEED_BENCHMARKS_CTRE__UTF8__HPP
#define ZTD_CUNEICODE_SPEED_BENCHMARKS_CTRE__UTF8__HPP
...
namespace ctre {
	...
	struct utf8_iterator {
		...
		constexpr char32_t operator*() const noexcept {
			...
			char32_t result
			     = static_cast<char32_t>((ptr[0] & mask) << 6u) | (ptr[1] & 0b0011'1111u);
